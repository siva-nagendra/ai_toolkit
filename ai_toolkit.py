...
#Chat agent
class Chat:
    def __init__(self, model, system="You are a helpful expert in Pixar OpenUSD and an advanced Computer Graphics AI assistant!", max_tokens=500, speech=False, temp=0.7):
        self.model = model
        self.speech = speech
        self.system = system
